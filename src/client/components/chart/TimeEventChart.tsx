...
export interface TimeEventChartProps {
  className?: string;
...
export const TimeEventChart: React.FC<TimeEventChartProps> = React.memo(
  (props) => {
    const {
      className,
    ...
    return (
      <ChartContainer className={className} config={chartConfig}>
        ...
        >
          ...
          {!hideLegend && (
            <ChartLegend
              className="max-h-24 flex-wrap gap-2 overflow-auto"
              content={
                <ChartLegendContent
